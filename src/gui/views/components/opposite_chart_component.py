...
class OppositeChart(wx.Panel):
    ...
    def set_panel_value(self, off_def, value, analytics):
        self.axis[off_def].clear()
        self.axis[off_def].set_axis_off()
        barColor = self._set_color(value, analytics)
        score = self._set_score(value, analytics)
